  ...
  return (
    <div className="space-y-6">
      <Alert>
        ...
        <AlertDescription>
          Mice can carry diseases and contaminate food. They can also cause
          structural damage by chewing through wires, insulation, and building
          materials. Address infestations promptly.
        </AlertDescription>
      </Alert>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Learn to recognize mice and evidence of their presence
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • <strong>House Mouse:</strong> 2.5-3.5 inches long (body),
                light brown to gray
              </li>
              <li>
                • <strong>Deer Mouse:</strong> 3-4 inches long, brown with white
                belly and feet
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • <strong>Droppings:</strong> Small (1/4 inch), dark, rod-shaped
                pellets near food sources
              </li>
              <li>
                • <strong>Gnaw marks:</strong> Small teeth marks on food
                packaging, wires, wood
              </li>
              <li>
                • <strong>Tracks:</strong> Small footprints in dust or flour
              </li>
              <li>
                • <strong>Runways:</strong> Greasy rub marks along walls and
                baseboards
              </li>
              <li>
                • <strong>Nests:</strong> Shredded paper, fabric, or insulation
                in hidden areas
              </li>
              <li>
                • <strong>Sounds:</strong> Scratching, squeaking, or scurrying
                noises, especially at night
              </li>
              <li>
                • <strong>Odor:</strong> Musky smell in enclosed spaces
              </li>
              <li>
                • <strong>Pet behavior:</strong> Cats or dogs acting alert near
                walls or furniture
              </li>
            </ul>
          </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Where mice live and how they enter homes
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • Gaps around pipes, vents, and utility lines (as small as 1/4
                inch)
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                • Reproduce rapidly (5-10 litters per year, 5-6 pups per litter)
              </li>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • Inspect exterior for gaps and cracks (use flashlight at night
                to spot light coming through)
              </li>
              <li>
                • Seal holes with steel wool, copper mesh, or hardware cloth
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                • Remove piles of debris, wood, and vegetation near the home
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                • Store firewood at least 20 feet from the home and elevated
              </li>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Steps to take when dealing with a mouse infestation
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                • Wear gloves when handling traps or cleaning contaminated areas
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • <strong>Snap traps:</strong> Effective and humane when used
                correctly
              </li>
              <li>
                • <strong>Live traps:</strong> Catch and release (release far
                from home)
              </li>
              <li>
                • <strong>Electronic traps:</strong> Quick and clean elimination
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                • Spray droppings and nesting materials with disinfectant before
                cleaning
              </li>
              <li>• Do not sweep or vacuum (can spread disease)</li>
              <li>
                • Use paper towels to pick up droppings and dispose in sealed
                bags
              </li>
              <li>
                • Disinfect all surfaces with bleach solution (1 part bleach to
                10 parts water)
              </li>
