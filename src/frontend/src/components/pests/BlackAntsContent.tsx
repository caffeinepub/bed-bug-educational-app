  ...
  return (
    <div className="space-y-6">
      <Alert>
        ...
        <AlertDescription>
          While black ants are generally not aggressive, some species can bite or sting if threatened. If you experience severe reactions, swelling, or signs of an allergic response, seek medical care immediately.
        </AlertDescription>
      </Alert>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Learn to recognize black ants and signs of their presence</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>• Size ranges from 1/16 to 1/2 inch depending on species and caste</li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>• <strong>Little Black Ant:</strong> Very small (1/16 inch), shiny black, common indoors</li>
              <li>• <strong>Black Garden Ant:</strong> Medium-sized (1/8 inch), dark brown to black, nests outdoors</li>
              <li>• <strong>Pavement Ant:</strong> Small (1/8 inch), dark brown to black, nests under pavement and foundations</li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>• Small piles of fine soil or sand near cracks (nest excavation)</li>
              <li>• Ants foraging in kitchens, pantries, or around food</li>
              <li>• Winged ants (swarmers) appearing indoors in spring or summer</li>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Where black ants nest and what draws them indoors</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            <h4 className="mb-2 font-semibold">Nesting Locations</h4>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>• Outdoors: under rocks, logs, mulch, pavement, and in soil</li>
              <li>• Near foundations and building perimeters</li>
              <li>• In wall voids, insulation, and behind baseboards</li>
              <li>• Under sinks and around plumbing where moisture is present</li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>• Sweet foods: sugar, honey, syrup, fruit, and sugary drinks</li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>• Colonies can contain thousands of workers and multiple queens</li>
              <li>• Scout ants search for food and recruit others when found</li>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Keep black ants from entering and establishing in your home</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>• Store pet food in sealed containers and clean bowls regularly</li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>• Caulk cracks and crevices in walls, foundations, and around windows</li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>• Keep mulch, leaf litter, and debris away from the foundation</li>
              ...
              <li>• Keep outdoor garbage cans sealed and away from entrances</li>
            </ul>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Steps to control and eliminate black ant infestations</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>• Clean surfaces with soap and water to remove pheromone trails</li>
              <li>• Vacuum up visible ants and dispose of the bag immediately</li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>• <strong>Ant baits:</strong> Place gel or granular baits along trails and near entry points; ants carry bait back to the colony</li>
              <li>• <strong>Bait stations:</strong> Use pre-filled stations for safer application around children and pets</li>
              <li>• <strong>Perimeter treatment:</strong> Apply residual insecticide spray around the foundation and entry points</li>
              <li>• <strong>Natural options:</strong> Diatomaceous earth or boric acid in cracks and crevices (use with caution)</li>
              <li>• Be patient: baits take several days to weeks to eliminate the colony</li>
              <li>• Don't spray ants directly when using baits—they need to carry it back to the nest</li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>• You're unsure about safe pesticide use around children or pets</li>
            </ul>
          </div>
        </CardContent>
      </Card>
