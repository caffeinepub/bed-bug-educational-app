  ...
  return (
    <div className="space-y-6">
      <Alert variant="destructive">
        ...
        <AlertDescription>
          Red ants, especially fire ants, can deliver painful stings that cause
          burning sensations, welts, and pustules. Some people may experience
          severe allergic reactions including difficulty breathing, chest pain,
          or anaphylaxis. If you experience severe symptoms, seek emergency
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Learn to recognize red ants and signs of their presence
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                • Size ranges from 1/8 to 1/4 inch depending on species and
                caste
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • <strong>Red Imported Fire Ant:</strong> Reddish-brown, 1/8-1/4
                inch, aggressive, painful sting, builds large mounds
              </li>
              <li>
                • <strong>Southern Fire Ant:</strong> Similar to imported fire
                ant but less aggressive, native to southern U.S.
              </li>
              <li>
                • <strong>Red Harvester Ant:</strong> Large (1/4-1/2 inch), red
                to dark red, painful sting, collects seeds
              </li>
              <li>
                • <strong>Pharaoh Ant:</strong> Small (1/16 inch), light yellow
                to red, common indoors, difficult to control
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • Dome-shaped mounds of loose soil in lawns and open areas (fire
                ants)
              </li>
              ...
              <li>
                • Winged reproductive ants (swarmers) in spring and summer
              </li>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Where red ants nest and what draws them to your property
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                • In electrical equipment and utility boxes (attracted to
                electrical fields)
              </li>
              <li>
                • Indoors: wall voids, under floors, in insulation (less common
                but serious)
              </li>
              <li>
                • Mounds can be 18 inches tall and 2 feet wide (fire ants)
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                • Sweet foods: honeydew from aphids, nectar, sugary substances
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                • Sting repeatedly, injecting venom that causes burning pain
              </li>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Reduce the risk of red ant infestations on your property
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                • Don't disturb mounds without proper treatment—ants will
                relocate
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                • Eliminate food sources: clean up spills, store food properly
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • Wear closed-toe shoes, long pants, and gloves when working
                outdoors
              </li>
              <li>• Teach children to recognize and avoid ant mounds</li>
              <li>• Keep pets away from known ant colonies</li>
              <li>
                • Be cautious when moving outdoor items that may harbor ants
              </li>
              <li>
                • Inspect play areas, picnic spots, and outdoor furniture before
                use
              </li>
            </ul>
          </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • Move away from the area immediately to avoid more stings
              </li>
              <li>
                • Brush or flick ants off—don't slap them (releases more venom)
              </li>
              ...
              <li>
                • Seek emergency medical care if you experience difficulty
                breathing, chest pain, severe swelling, dizziness, or signs of
                anaphylaxis
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • <strong>Individual mound treatment:</strong> Apply mound
                drench or granular insecticide directly to mounds according to
                label instructions
              </li>
              <li>
                • <strong>Bait treatment:</strong> Broadcast fire ant bait over
                the entire yard; ants carry bait back to the colony
              </li>
              <li>
                • <strong>Two-step method:</strong> Combine broadcast bait with
                individual mound treatments for best results
              </li>
              <li>
                • Treat in early morning or late evening when ants are most
                active
              </li>
              <li>• Avoid watering treated areas for 24-48 hours</li>
              <li>
                • Reapply treatments as needed and according to product labels
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                • Don't spray ants when using baits—they need to carry it back
              </li>
              <li>• Seal entry points after ant activity decreases</li>
              <li>
                • For pharaoh ants, use only non-repellent baits (sprays can
                cause colony splitting)
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • <strong>Fire ant infestations:</strong> Professional treatment
                is highly recommended due to aggressive behavior and difficulty
                of control
              </li>
      ...
      <Alert>
        ...
        <AlertDescription>
          Fire ant stings typically cause immediate pain, burning, and itching,
          followed by the formation of pustules within 24 hours. While most
          reactions are localized, some individuals may experience severe
          allergic reactions. If you have a known allergy to insect stings or
          experience symptoms beyond the sting site, seek medical attention
          promptly.
        </AlertDescription>
      </Alert>
    </div>
