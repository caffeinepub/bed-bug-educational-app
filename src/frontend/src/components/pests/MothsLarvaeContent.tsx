  ...
  return (
    <div className="space-y-6">
      <Alert>
        ...
        <AlertDescription>
          Moths and their larvae can damage clothing, fabrics, and stored foods.
          Early detection and prevention are key to protecting your belongings.
        </AlertDescription>
      </Alert>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Learn to recognize moths, larvae, and signs of infestation
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • <strong>Clothes Moths:</strong> Small (1/4 to 1/2 inch),
                golden or buff-colored, avoid light
              </li>
              <li>
                • <strong>Pantry Moths:</strong> Slightly larger (1/2 to 5/8
                inch), gray with copper/bronze markings
              </li>
              <li>• Weak fliers that prefer to run or hop rather than fly</li>
              <li>• Often found resting on walls or in dark corners</li>
              <li>
                • Attracted to natural fibers (wool, silk, fur) or stored foods
              </li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • Irregular holes in fabrics, especially wool, silk, or fur
                items
              </li>
              ...
              <li>
                • Adult moths flying near closets, pantries, or storage areas
              </li>
              <li>
                • Fecal pellets (frass) that look like fine sand or pepper
              </li>
            </ul>
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Common locations and what attracts moths
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                • Storage boxes containing natural fiber clothing or blankets
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • Soiled or stained fabrics (sweat, food, body oils attract
                them)
              </li>
              <li>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • Clean all clothing before storing, especially items with
                stains
              </li>
              <li>
                • Store natural fiber items in airtight containers or sealed
                bags
              </li>
              <li>
                • Use cedar blocks, lavender sachets, or moth repellent products
              </li>
              <li>
                • Regularly vacuum closets, carpets, and upholstered furniture
              </li>
              <li>• Brush or shake out garments periodically</li>
              <li>• Keep storage areas well-ventilated and dry</li>
              <li>
                • Avoid storing items in cardboard boxes (moths can chew
                through)
              </li>
            </ul>
          </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Steps to take when you discover moths or larvae
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • Identify the type of moth (clothes moth vs. pantry moth)
              </li>
              ...
              <li>
                • Dispose of vacuum bag or empty canister outside immediately
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                • Freeze items for at least 72 hours (kills all life stages)
              </li>
