...
export function EducationalContent() {
  ...
  // On mount: read ?pest= query param and navigate to the identify tab for that pest
  useEffect(() => {
    const params = new URLSearchParams(window.location.search);
    const pestParam = params.get("pest");
    const validPests = [
      "bedbugs",
      "scorpions",
      "mice",
    ...
    if (pestParam && (validPests as readonly string[]).includes(pestParam)) {
      ...
      // Clean up the query param from the URL, keeping the hash
      window.history.replaceState(
        {},
        "",
        `${window.location.pathname}#identify`,
      );
    }
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: getActiveTab reads currentHash, no stable ref needed
  useEffect(() => {
      ...
      <div className="mx-auto max-w-5xl">
        <div className="mb-8 text-center">
          ...
          <p className="text-lg text-muted-foreground">
            Learn about common household pests, how to identify them, and
              ...
              <CardContent className="pt-6">
                <div className="mb-4 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Choose which pest you want to learn about
                  </p>
                </div>
          ...
          <TabsContent value="guides" className="mt-6">
            ...
            {selectedPest === "bedbugs" ? (
              <>
                ...
                <div className="mt-6">
                  <PrintableGuides
                    contentType={pestInfo.contentType}
                    sectionTitle={pestInfo.title}
                  />
                </div>
              </>
            ) : (
