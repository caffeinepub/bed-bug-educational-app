  ...
  return (
    <div className="space-y-6">
      <Alert>
        ...
        <AlertDescription>
          Earwigs are generally harmless to humans and rarely bite. While they
          have intimidating pincers (cerci), they primarily use them for defense
          and mating. They're more of a nuisance pest than a health threat.
        </AlertDescription>
      </Alert>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Learn to recognize earwigs and signs of their presence
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                • Distinctive pair of forceps-like pincers (cerci) at the rear
                end
              </li>
              <li>
                • Males have curved pincers; females have straighter pincers
              </li>
              <li>• Long, thread-like antennae</li>
              <li>
                • Six legs and two pairs of wings (though they rarely fly)
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • Live earwigs found in damp areas like bathrooms, basements, or
                laundry rooms
              </li>
              <li>
                • Earwigs hiding in folded towels, newspapers, or stored items
              </li>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Where earwigs live and what draws them indoors
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • <strong>Moisture:</strong> The primary attractant - leaky
                pipes, damp basements, wet areas
              </li>
              <li>
                • <strong>Shelter:</strong> Dark, tight spaces that provide
                protection
              </li>
              <li>
                • <strong>Food sources:</strong> Decaying organic matter,
                plants, small insects
              </li>
              <li>
                • <strong>Outdoor lighting:</strong> Lights near entry points
                attract them at night
              </li>
              <li>
                • <strong>Mulch and debris:</strong> Outdoor populations near
                the foundation can migrate indoors
              </li>
            </ul>
          </div>
          <div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Keep earwigs from entering and establishing in your home
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                • Repair roof leaks and improve drainage around the foundation
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                • Seal gaps around utility pipes and wires entering the home
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • Keep mulch at least 6-12 inches away from the foundation
              </li>
              <li>
                • Remove leaf litter, grass clippings, and organic debris near
                the home
              </li>
              <li>• Store firewood away from the house and off the ground</li>
              <li>
                • Trim vegetation and ground cover away from the foundation
              </li>
              <li>
                • Remove boards, stones, and other hiding places near the home
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • Reduce indoor clutter, especially stacks of paper and
                cardboard
              </li>
              <li>
                • Vacuum regularly to remove earwigs and their hiding spots
              </li>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • Vacuum up visible earwigs and dispose of the vacuum bag or
                contents outdoors
              </li>
              <li>
                • Use a broom and dustpan to sweep them up and release outdoors
              </li>
              <li>
                • Trap earwigs in rolled-up damp newspaper overnight, then
                dispose of it in the morning
              </li>
              <li>
                • Place shallow dishes of vegetable oil mixed with soy sauce as
                traps (earwigs are attracted and drown)
              </li>
              <li>
                • Reduce indoor moisture immediately to make the environment
                less hospitable
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • Apply diatomaceous earth (food-grade) in cracks, crevices, and
                entry points
              </li>
              <li>
                • Use boric acid powder in wall voids and hidden areas (keep
                away from children and pets)
              </li>
              <li>
                • Apply residual insecticide sprays around the foundation
                perimeter outdoors
              </li>
              <li>
                • Use insecticidal dust in crawl spaces and attics if needed
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                • Large or persistent infestations that don't respond to DIY
                methods
              </li>
              ...
              <li>
                • Structural moisture issues that require professional
                assessment
              </li>
            </ul>
          </div>
